...
<ul class="nav nav-tabs" id="WPMSFormTab" role="tablist">
  <li class="nav-item">
    <a class="nav-link disabled active" id="wpmsf-tab-1" data-toggle="tab" href="#wpmsf-content-1" role="tab" aria-controls="wpmsf-content-1" aria-selected="true">Contact Details</a>
  </li>
  <li class="nav-item">
    <a class="nav-link disabled" id="wpmsf-tab-2" data-toggle="tab" href="#wpmsf-content-2" role="tab" aria-controls="wpmsf-content-2" aria-selected="false">Vehicle Details</a>
  </li>
  <li class="nav-item">
  ...
  <li class="nav-item">
    <a class="nav-link disabled" id="wpmsf-tab-6" data-toggle="tab" href="#wpmsf-content-6" role="tab" aria-controls="wpmsf-content-6" aria-selected="false">At Fault Party’s Vehicle Detail</a>
  </li>
  <li class="nav-item">
